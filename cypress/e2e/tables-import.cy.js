...
describe('Import csv from Files file action', () => {
	...
	it('Import small file to new table', () => {
		cy.get('[data-cy-files-list-row-name="test-import-small.csv"] [data-cy-files-list-row-actions] .action-item button').click()
	...
	it('Import large file to new table', () => {
		cy.get('[data-cy-files-list-row-name="test-import-large.csv"] [data-cy-files-list-row-actions] .action-item button').click()
		cy.get('[data-cy-files-list-row-action="import-to-tables"]').click()
