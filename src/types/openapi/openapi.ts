...
export type paths = {
  ...
  "/index.php/apps/tables/api/1/tables/{tableId}/scheme": {
    ...
    get: operations["api1-show-scheme"];
  };
  ...
  "/ocs/v2.php/apps/tables/api/2/tables/scheme/{id}": {
    ...
    get: operations["api_tables-show-scheme"];
  };
  "/ocs/v2.php/apps/tables/api/2/tables/scheme": {
    /** creates table from scheme */
    post: operations["api_tables-create-from-scheme"];
  };
