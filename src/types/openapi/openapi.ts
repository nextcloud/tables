...
export type paths = {
    ...
    readonly "/ocs/v2.php/apps/tables/api/2/tables/{id}/scheme/preview-changes": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        readonly post: operations["api_tables-preview-scheme-changes"];
        readonly delete?: never;
        readonly options?: never;
        readonly head?: never;
        readonly patch?: never;
    ...
    readonly "/ocs/v2.php/apps/tables/api/2/tables/{id}/scheme/import": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        readonly post: operations["api_tables-import-scheme"];
        readonly delete?: never;
        readonly options?: never;
        readonly head?: never;
        readonly patch?: never;
    ...
    readonly "/ocs/v2.php/apps/tables/api/2/tables/{id}/archive": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
         ...
         * @description Owners archive the table for all users (clears per-user overrides). Non-owners archive only for themselves.
         */
        readonly post: operations["api_tables-archive-table"];
        /**
         * [api v2] Unarchive a table for the requesting user
         * @description Owners unarchive the table for all users (clears per-user overrides). Non-owners remove only their personal archive override.
         */
        readonly delete: operations["api_tables-unarchive-table"];
        readonly options?: never;
        readonly head?: never;
        readonly patch?: never;
        readonly trace?: never;
    ...
    readonly "/ocs/v2.php/apps/tables/api/2/contexts/{contextId}/scheme/export": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        readonly get: operations["context-export-scheme"];
        readonly put?: never;
        readonly post?: never;
        readonly delete?: never;
        readonly options?: never;
    ...
    readonly "/ocs/v2.php/apps/tables/api/2/contexts/{contextId}/scheme/preview-changes": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        readonly post: operations["context-preview-scheme-changes"];
        readonly delete?: never;
        readonly options?: never;
        readonly head?: never;
        readonly patch?: never;
    ...
    readonly "/ocs/v2.php/apps/tables/api/2/contexts/{contextId}/scheme/import": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        readonly post: operations["context-import-scheme"];
        readonly delete?: never;
        readonly options?: never;
        readonly head?: never;
        readonly patch?: never;
    ...
    readonly "/ocs/v2.php/apps/tables/api/2/contexts/{contextId}/archive": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
         ...
         * @description Owners archive the context for all users (clears per-user overrides). Non-owners archive only for themselves.
         */
        readonly post: operations["context-archive-context"];
        /**
         * [api v2] Unarchive a context for the requesting user
         * @description Owners unarchive the context for all users (clears per-user overrides). Non-owners remove only their personal archive override.
         */
        readonly delete: operations["context-unarchive-context"];
        readonly options?: never;
        readonly head?: never;
        readonly patch?: never;
        readonly trace?: never;
    ...
    readonly "/ocs/v2.php/apps/tables/api/2/{nodeCollection}/{nodeId}/rows/{rowId}": {
        readonly parameters: {
            readonly query?: never;
            readonly header?: never;
            readonly path?: never;
        ...
        readonly put: operations["rowocs-update-row"];
        readonly post?: never;
        /** [api v2] Delete a row in a table or a view */
        readonly delete: operations["rowocs-delete-row"];
        readonly options?: never;
        readonly head?: never;
        readonly patch?: never;
        readonly trace?: never;
...
export interface operations {
        ...
        readonly requestBody?: {
            readonly content: {
                readonly "application/json": {
                    ...
                    readonly emoji?: string | null;
                    /**
                     * @description Whether the table is archived; the state is kept unchanged when omitted
                     * @default null
                     */
    ...
    readonly "api_tables-preview-scheme-changes": {
        readonly parameters: {
            readonly query?: never;
            readonly header: {
                /** @description Required to be true for the API request to pass */
        ...
        readonly requestBody: {
            readonly content: {
                readonly "application/json": {
                    ...
                    readonly updateScheme: components["schemas"]["Table"];
                };
            };
        };
        readonly responses: {
            /** @description Changes preview returned */
            readonly 200: {
                headers: {
                    readonly [name: string]: unknown;
                };
                content: {
                    readonly "application/json": {
                        readonly ocs: {
                            readonly meta: components["schemas"]["OCSMeta"];
                            readonly data: {
                                readonly addedColumns: readonly components["schemas"]["Column"][];
                                readonly removedColumns: readonly components["schemas"]["Column"][];
                                readonly modifiedColumns: readonly components["schemas"]["Column"][];
                            };
                        };
                    };
                };
    ...
    readonly "api_tables-import-scheme": {
        readonly parameters: {
            readonly query?: never;
            readonly header: {
                /** @description Required to be true for the API request to pass */
        ...
        readonly requestBody: {
            readonly content: {
                readonly "application/json": {
                    /** @description Title of the table */
                    readonly title: string;
                    /** @description Emoji of the table */
                    readonly emoji: string;
                    /** @description description of the table */
                    readonly description: string;
                    /** @description definitions of columns to add, remove or modify */
                    readonly columns: {
                        readonly addColumns: readonly components["schemas"]["Column"][];
                        readonly modifyColumns: readonly components["schemas"]["Column"][];
                        readonly removeColumns: readonly components["schemas"]["Column"][];
                    };
                    /** @description Definition of the views */
                    readonly views: readonly components["schemas"]["View"][];
                    /**
                     * @description Ordered meta data of the columns
                     * @default []
                     */
                    readonly columnOrder?: readonly {
                        /** Format: int64 */
                    ...
                    /**
                     * @description Meta data of the sort rules
                     * @default []
                     */
                    readonly sort?: readonly {
                        /** Format: int64 */
    ...
    readonly "api_tables-archive-table": {
        readonly parameters: {
            readonly query?: never;
            readonly header: {
                /** @description Required to be true for the API request to pass */
        ...
        readonly requestBody?: never;
        readonly responses: {
            /** @description Table returned with updated archived state */
            readonly 200: {
                headers: {
                    readonly [name: string]: unknown;
                };
    ...
    readonly "api_tables-unarchive-table": {
        readonly parameters: {
            readonly query?: never;
            readonly header: {
                /** @description Required to be true for the API request to pass */
    ...
    readonly "context-export-scheme": {
        readonly parameters: {
            readonly query?: never;
            readonly header: {
                /** @description Required to be true for the API request to pass */
        ...
        readonly requestBody?: never;
        readonly responses: {
            /** @description returning the scheme of the context */
            readonly 200: {
                headers: {
                    readonly [name: string]: unknown;
                };
    ...
    readonly "context-preview-scheme-changes": {
        readonly parameters: {
            readonly query?: never;
            readonly header: {
                /** @description Required to be true for the API request to pass */
        ...
        readonly requestBody: {
            readonly content: {
                readonly "application/json": {
                    /** @description New scheme of the context */
                    readonly updateScheme: components["schemas"]["Context"];
                };
            };
        };
        readonly responses: {
            /** @description returning the changes that would be applied to the context scheme */
            readonly 200: {
                headers: {
                    readonly [name: string]: unknown;
                };
    ...
    readonly "context-import-scheme": {
        readonly parameters: {
            readonly query?: never;
            readonly header: {
                /** @description Required to be true for the API request to pass */
        ...
        readonly requestBody: {
            readonly content: {
                readonly "application/json": {
                    ...
                    readonly name: string;
                    /** @description Identifier of the context icon */
                    readonly iconName: string;
                    /** @description Description of the context */
                    readonly description: string;
                    /** @description Ordered meta data of the related nodes */
                    readonly nodes: readonly {
                        /** Format: int64 */
                    ...
                    /** @description Tables to be added or modified */
                    readonly tables: {
    ...
    readonly "context-archive-context": {
        readonly parameters: {
            readonly query?: never;
            readonly header: {
                /** @description Required to be true for the API request to pass */
        ...
        readonly requestBody?: never;
        readonly responses: {
            /** @description Context returned with updated archived state */
            readonly 200: {
                headers: {
                    readonly [name: string]: unknown;
                };
    ...
    readonly "context-unarchive-context": {
        readonly parameters: {
            readonly query?: never;
            readonly header: {
                /** @description Required to be true for the API request to pass */
    ...
    readonly "rowocs-update-row": {
        readonly parameters: {
            ...
            readonly path: {
                /** @description Indicates whether to update a row on a table or view */
                readonly nodeCollection: "tables" | "views";
                /** @description The identifier of the targeted table or view */
                readonly nodeId: number;
                /** @description The identifier of the row to update */
                readonly rowId: number;
            };
            readonly cookie?: never;
        };
    ...
    readonly "rowocs-delete-row": {
        readonly parameters: {
            ...
            readonly path: {
                /** @description Indicates whether to delete a row on a table or view */
                readonly nodeCollection: "tables" | "views";
                /** @description The identifier of the targeted table or view */
                readonly nodeId: number;
                /** @description The identifier of the row to delete */
                readonly rowId: number;
            };
            readonly cookie?: never;
        };
