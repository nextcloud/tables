<template>
	<table v-if="column">
		...
		<tr>
			<td>{{ t('tables', 'Allowed pattern') }}</td><td>{{ column.textAllowedPattern | truncate(20, '...') }}</td>
		</tr>
		<tr>
...
export default {
	...
	computed: {
		maxLength() {
			return (this.column.textMaxLength && this.column.textMaxLength === -1) ? '' : this.column.textMaxLength
		},
	},
}
</script>
