...
<template>
	<div>
		...
		<div>
			<DialogConfirmation :description="t('tables', 'After promotion, any applications based on this table created by this user will continue to consume its data even if you demote them later')"
