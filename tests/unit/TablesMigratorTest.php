...
class TablesMigratorTest extends TestCase
{
    ...
    public function testExportSuccess(): void
    {
        ...
        $this->shareMapper->method('findByNodeIdsAndTypes')->willReturn([]);
    ...
    public function testImportSuccess(): void
    {
        ...
        $this->favoritesService->method('findAll')->willReturn([]);
        $this->columnService->method('importColumn')->willReturn($this->createMock(Column::class));
        $this->rowService->method('importRow')->willReturn($this->createMock(Row2::class));
