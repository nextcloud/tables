	...
	public static function filteringDataProvider(): array {
		return [
			...
			'Experience years is lower than 5' => [
				...
				['Bob', 'Charlie', 'Diana'],  // People with experience 2, 3 years
				'Filter by experience years lower than 5 - should include 2 rows, exclude 3'
			],
			...
			'Available is equal to true' => [
				...
				['Alice', 'Charlie'],  // People with is_available = "true"
			...
			'Available is equal to false' => [
				...
				['Bob', 'Diana'],  // People with is_available = "false"
			...
			'Status contains "Active"' => [
				...
				['Alice', 'Charlie', 'Eve'],  // People with status "Active" (id: 0)
			...
			'Skills contains "PHP"' => [
				...
				['Alice'],  // People with skills "PHP" (id: 0)
			...
			'Skills contains "Python"' => [
				...
				['Charlie'],  // People with skills "Python" (id: 3)
