...
class ShareMapperShareReviewTest extends DatabaseTestCase {
	...
	public function testModifiedBeforeIsExclusiveAndFormsAHalfOpenRangeWithSince(): void {
		// edits on 05-01, 03-01, 04-01, 02-01, 01-01: strictly before 03-01 10:00 leaves February and January
		$this->assertSame(2, $this->filteredCount(new ShareReviewQuery(modifiedBeforeTimestamp: strtotime('2026-03-01 10:00:00'))));
		// 02-01 10:00 < t < 05-01 10:00 is March and April
