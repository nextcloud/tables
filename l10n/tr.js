OC.L10N.register(
    ...
    "Import" : "İçe aktar",
    "File" : "Dosya",
    "Supported formats are xlsx, xls, html, xml and csv." : "Desteklenen biçimler xlsx, xls, html, xml ve csv.",
    "Select a file" : "Bir dosya seçin",
    "Create missing columns" : "Eksik sütunlar oluşturulsun",
    "Columns are identified by the titles. If there is no match, a new text-line column will be created." : "Sütunlar başlıklarla tanımlanır. Eşleşme yoksa,Ω yeni bir metin satırı sütunu oluşturulur.",
    "⚠️ You don't have the permission to create columns." : "Sütunlar oluşturma izniniz yok.",
    "Information" : "Bilgiler",
    "The first row has to contain the column titles." : "İlk satırda sütun başlıkları bulunmalıdır.",
    "Note that imported data will be added to the table. Updating of existing rows is not possible at the moment." : "İçe aktarılan verilerin tabloya ekleneceğini unutmayın. Var olan satırların güncellenmesi şu anda desteklenmiyor.",
    "The possible importing size depends on the system configuration and is only limited by execution time and memory." : "Olası içe aktarma boyutu, sistem yapılandırmasına bağlıdır ve yalnızca yürütme süresi ve bellekle sınırlıdır.",
    "Result" : "Sonuç",
    "Found columns" : "Bulunan sütunlar",
    "Created columns" : "Oluşturulan sütunlar",
    "Inserted rows" : "Eklenen satırlar",
    "Errors" : "Hatalar",
    "Error during importing. Please read the logs for more information." : "İçe aktarma sırasında sorun çıktı. Ayrıntılı bilgi almak için lütfen günlük kayıtlarına bakın.",
    "Importing..." : "İçe aktarılıyor...",
    "Please wait while we try our best to import your data. This might take some time, depending on the server configuration." : "Verilerinizi içe aktarmak için elimizden gelenin en iyisini yaparken lütfen bekleyin. Bu işlem, sunucu yapılandırmasına bağlı olarak biraz zaman alabilir.",
