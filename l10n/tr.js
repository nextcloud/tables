OC.L10N.register(
    ...
    "If you try to import with the order of columns, see the third attemp above, you need to blind columns at the beginnig." : "Sütun sırasına göre içe aktarmayı denerseniz, yukarıdaki üçüncü denemeye bakın. Başlangıçta sütunları körlemeniz gerekir.",
    "If you are on a Chrome browser, you have to create a row first. this one can be clicked an the insert process should run." : "Chrome web tarayıcısı kullanıyorsanız, önce bir satır oluşturmanız gerekir. Buna tıklanabilir ve ekleme işleminin çalışması gerekir.",
    ...
    "There is a bug with the editor on mobile devices, thats why you see only a simple text box." : "Mobil aygıtlarda düzenleyicide bir sorun var. Bu yüzden yalnızca basit bir metin kutusu görüyorsunuz."
},
