OC.L10N.register(
    ...
    "If you are on a Chrome browser, you have to create a row first. Click on this newly created row and the insert process should run." : "Chrome tarayıcısı kullanıyorsanız, önce bir satır oluşturmanız gerekir. Yeni oluşturulan satıra tıkladığınızda ekleme işleminin yapılması gerekir.",
