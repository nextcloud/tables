OC.L10N.register(
    "tables",
    {
    "You have created a new table {table}" : "{table} tablosunu eklediniz",
    "{user} has created a new table {table}" : "{user}, {table} tablosunu ekledi",
    ...
    "Deleted circle %s." : "%s çevresi silindi.",
    "Nextcloud tables" : "Nextcloud tabloları",
    ...
    "Use the *+ Create row* button and enter some data inside of the form." : "*+ Satır ekle* düğmesini kullanın ve formun içine bazı veriler yazın.",
    ...
    "You can add, remove and adjust columns as you need. Open the three-dot-menu on the upper right of this table and choose *Create column*. Fill in the data you want, at least a title and column type." : "Gereksinimlerinize göre sütun ekleyebilir, kaldırabilir ve ayarlayabilirsiniz. Bu tablonun sağ üst köşesindeki üç nokta menüsünü açın ve *Sütun ekle* üzerine tıklayın. İstediğiniz verileri, en azından bir başlık ve sütun türünü yazın.",
    "Create views for tables" : "Tablolar için görünümler ekleyin",
