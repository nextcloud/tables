OC.L10N.register(
    ...
    "Search and filter (type @)" : "Arama ve süzgeç (@ yazın)",
    "Column to filter by" : "Süzülecek sütun",
    "If you are trying to add a filter, make sure to choose a column, operator and filter value." : "Bir süzgeç eklemeye çalışıyorsanız, bir sütun, işlem ve süzgeç değeri seçtiğinizden emin olun.",
    "Please specify a filter value." : "Lütfen bir süzgeç değeri belirtin.",
    "This option is outdated." : "Bu seçenek kullanımdan kaldırılmış",
    "Export as CSV" : "CSV olarak dışa aktar",
    "Sort this column" : "Bu sütüne göre sırala",
    "Undo" : "Geri al",
    "Redo" : "Yinele",
    "Bold" : "Koyu",
    "Italic" : "Yatık",
