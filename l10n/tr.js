OC.L10N.register(
    ...
    "Cannot create new context. Title is missing." : "Yeni bağlam oluşturulamadı. Başlık eksik",
    ...
    "The title limit is reached with 200 characters." : "Başlık en fazla 200 karakter uzunluğunda olabilir.",
    "Cannot update context. Title is missing." : "Bağlam güncellenemedi. Başlık eksik.",
    "Updated context \"{contextTitle}\"." : "\"{contextTitle}\" bağlamı güncellendi.",
    ...
    "Transfer" : "Aktar",
    "Context \"{name}\" transfered to {user}" : "\"{name}\" bağlamı {user} kullanıcısına aktarıldı",
