OC.L10N.register(
    ...
    "Search and filter (type @)" : "Search and filter (type @)",
    "Column to filter by" : "Column to filter by",
    "If you are trying to add a filter, make sure to choose a column, operator and filter value." : "If you are trying to add a filter, make sure to choose a column, operator and filter value.",
    "Please specify a filter value." : "Please specify a filter value.",
