OC.L10N.register(
    ...
    "Column to filter for" : "Column to filter for",
    "You try to add a filter, make sure to chose a column, operator and filter value." : "You try to add a filter, make sure to choose a column, operator and filter value.",
