OC.L10N.register(
    "tables",
    {
    "You have imported file to table {table}" : "Tá comhad allmhairithe agat chuig tábla {table}",
    "{user} has imported file to table {table}" : "Tá comhad allmhairithe ag {user} chuig tábla {table}",
    ...
    "You have updated the table {table}" : "Tá an tábla {table} nuashonraithe agat",
    "{user} has updated the table {table}" : "Tá an tábla {table} nuashonraithe ag {user}",
    ...
    "You have created a new view {view} in table {table}" : "Tá radharc nua {view} cruthaithe agat i dtábla {table}",
    "{user} has created a new view {view} in table {table}" : "Chruthaigh {user} radharc nua {view} sa tábla {table}",
    "You have updated the view {view} in table {table}" : "Tá an radharc {view} i dtábla {table} nuashonraithe agat",
    "{user} has updated the view {view} in table {table}" : "Tá an radharc {view} i dtábla {table} nuashonraithe ag {user}",
    "You have deleted the view {view} from table {table}" : "Scrios tú an radharc {view} ón tábla {table}",
    "{user} has deleted the view {view} from table {table}" : "Scrios {user} an radharc {view} ón tábla {table}",
    "You have renamed the view {before} to {view} in table {table}" : "Tá an radharc {before} athainmnithe agat go {view} sa tábla {table}",
    "{user} has renamed the view {before} to {view} in table {table}" : "Tá {user} tar éis an radharc {before} a athainmniú go {view} sa tábla {table}",
    "You have updated the description of view {view} to {after} in table {table}" : "Tá cur síos ar radharc {view} nuashonraithe agat go {after} sa tábla {table}",
    "{user} has updated the description of view {view} to {after} in table {table}" : "<br>Tá cur síos ar radharc {view} nuashonraithe ag {user} go {after} sa tábla {table}",
    "You have created a new row {row} in view {view}" : "Tá sraith nua {row} cruthaithe agat i radharc {view}",
    "{user} has created a new row {row} in view {view}" : "Chruthaigh {user} sraith nua {row} i radharc {view}",
    ...
    "You have deleted the row {row} in view {view}" : "Scrios tú an tsraith {row} i radharc {view}",
    "{user} has deleted the row {row} in view {view}" : "Scrios {user} an tsraith {row} i radharc {view}",
    ...
    "_You have updated cell %1$s on row {row} in view {view}_::_You have updated cells %1$s on row {row} in view {view}_" : ["Tá cill %1$s nuashonraithe agat ar shraith {row} san amharc {view}","Tá cealla %1$s nuashonraithe agat ar shraith {row} san amharc {view}","Tá cealla %1$s nuashonraithe agat ar shraith {row} san amharc {view}","Tá cealla %1$s nuashonraithe agat ar shraith {row} san amharc {view}","Tá cealla %1$s nuashonraithe agat ar shraith {row} san amharc {view}"],
    "_{user} has updated cell %1$s on row {row} in view {view}_::_{user} has updated cells %1$s on row {row} in view {view}_" : ["Tá cill %1$s nuashonraithe ag {user} ar shraith {row} sa radharc {view}","Tá cealla %1$s nuashonraithe ag {user} ar an tsraith {row} sa radharc {view}","Tá cealla %1$s nuashonraithe ag {user} ar an tsraith {row} sa radharc {view}","Tá cealla %1$s nuashonraithe ag {user} ar an tsraith {row} sa radharc {view}","Tá cealla %1$s nuashonraithe ag {user} ar an tsraith {row} sa radharc {view}"],
    ...
    "You have created a new column {column} in view {view}" : "Tá colún nua {column} cruthaithe agat i radharc {view}",
    "{user} has created a new column {column} in view {view}" : "Chruthaigh {user} colún nua {column} i radharc {view}",
    "You have updated the column {column} in view {view}" : "Tá an colún {column} nuashonraithe agat i radharc {view}",
    "{user} has updated the column {column} in view {view}" : "Tá an colún {column} nuashonraithe ag {user} i radharc {view}",
    "You have deleted the column {column} from view {view}" : "Scrios tú an colún {column} as an radharc {view}",
    "{user} has deleted the column {column} from view {view}" : "Scrios {user} an colún {column} as radharc {view}",
    "You have created a new column {column} in table {table}" : "Tá colún nua {column} cruthaithe agat i dtábla {table}",
    "{user} has created a new column {column} in table {table}" : "Chruthaigh {user} colún nua {column} sa tábla {table}",
    "You have updated the column {column} in table {table}" : "Tá an colún {column} i dtábla {table} nuashonraithe agat.",
    "{user} has updated the column {column} in table {table}" : "Tá an colún {column} i dtábla {table} nuashonraithe ag {user}",
    "You have deleted the column {column} from table {table}" : "Scrios tú an colún {column} ón tábla {table}",
    "{user} has deleted the column {column} from table {table}" : "Scrios {user} an colún {column} ón tábla {table}",
    "{user} has shared view {view} with you" : "Tá radharc {view} roinnte ag {user} leat",
    "You have shared the view {view} as public link" : "Tá an radharc {view} roinnte agat mar nasc poiblí",
    "{user} has shared the view {view} as public link" : "Tá an radharc {view} roinnte ag {user} mar nasc poiblí",
    "You have shared the view {view} with {sharedWith}" : "Tá an radharc {view} roinnte agat le {sharedWith}",
    "{user} has shared the view {view} with {sharedWith}" : "Tá an radharc {view} roinnte ag {user} le {sharedWith}",
    "{user} has shared table {table} with you" : "Tá tábla {table} roinnte ag {user} leat",
    "You have shared the table {table} as public link" : "Tá an tábla {table} roinnte agat mar nasc poiblí",
    "{user} has shared the table {table} as public link" : "Tá an tábla {table} roinnte ag {user} mar nasc poiblí",
    "You have shared the table {table} with {sharedWith}" : "Tá an tábla {table} roinnte agat le {sharedWith}",
    "{user} has shared the table {table} with {sharedWith}" : "Tá an tábla {table} roinnte ag {user} le {sharedWith}",
    "{user} has updated sharing for the view {view} with you" : "Tá comhroinnt don radharc {view} leat nuashonraithe ag {user}",
    "You have updated public link sharing for the view {view}" : "Tá comhroinnt nasc poiblí nuashonraithe agat don radharc {view}",
    "{user} has updated public link sharing for the view {view}" : "Tá comhroinnt nasc poiblí nuashonraithe ag {user} don radharc {view}",
    "You have updated sharing for the view {view} with {sharedWith}" : "Tá comhroinnt nuashonraithe agat don radharc {view} le {sharedWith}",
    "{user} has updated sharing for the view {view} with {sharedWith}" : "Tá comhroinnt nuashonraithe ag {user} don radharc {view} le {sharedWith}",
    "{user} has updated sharing for the table {table} with you" : "Tá comhroinnt an tábla {table} leat nuashonraithe ag {user}",
    "You have updated public link sharing for the table {table}" : "Tá comhroinnt nasc poiblí nuashonraithe agat don tábla {table}",
    "{user} has updated public link sharing for the table {table}" : "Tá comhroinnt nasc poiblí don tábla {table} nuashonraithe ag {user}",
    "You have updated sharing for the table {table} with {sharedWith}" : "Tá comhroinnt an tábla {table} nuashonraithe agat le {sharedWith}",
    "{user} has updated sharing for the table {table} with {sharedWith}" : "Tá comhroinnt an tábla {table} nuashonraithe ag {user} le {sharedWith}",
    "{user} has removed sharing for the view {view} with you" : "Tá an comhroinnt don radharc {view} leat bainte ag {user}",
    "You have removed public link sharing for the view {view}" : "Bhain tú comhroinnt nasc poiblí don radharc {view}",
    "{user} has removed public link sharing for the view {view}" : "Bhain {user} comhroinnt nasc poiblí don radharc {view}",
    "You have removed sharing for the view {view} with {sharedWith}" : "Tá comhroinnt bainte agat don radharc {view} le {sharedWith}",
    "{user} has removed sharing for the view {view} with {sharedWith}" : "Tá comhroinnt an radhairc {view} bainte ag {user} le {sharedWith}",
    "{user} has removed sharing for the table {table} with you" : "Tá comhroinnt an tábla {table} leat bainte ag {user}",
    "You have removed public link sharing for the table {table}" : "Tá comhroinnt nasc poiblí bainte agat don tábla {table}",
    "{user} has removed public link sharing for the table {table}" : "Bhain {user} comhroinnt nasc poiblí don tábla {table}",
    "You have removed sharing for the table {table} with {sharedWith}" : "Tá comhroinnt an tábla {table} le {sharedWith} bainte agat.",
    "{user} has removed sharing for the table {table} with {sharedWith}" : "Tá comhroinnt an tábla {table} le {sharedWith} bainte ag {user}",
    "Found columns: {foundColumnsCount}" : "Colúin aimsithe: {foundColumnsCount}",
    "Matching columns: {matchingColumnsCount}" : "Colúin chomhoiriúnacha: {matchingColumnsCount}",
    "Created columns: {createdColumnsCount}" : "Colúin chruthaithe: {createdColumnsCount}",
    "Inserted rows: {insertedRowsCount}" : "Sraitheanna curtha isteach: {insertedRowsCount}",
    "Updated rows: {updatedRowsCount}" : "Sraitheanna nuashonraithe: {updatedRowsCount}",
    "Value parsing errors: {errorsParsingCount}" : "Earráidí parsála luacha: {errorsParsingCount}",
    "Row creation errors: {errorsCount}" : "Earráidí cruthaithe sraithe: {errorsCount}",
    "Tables" : "Táblaí",
    "A <strong>table or view</strong> was changed" : "<br>Athraíodh <strong>tábla nó radharc</strong>",
    "A <strong>table or view</strong> was shared with you" : "Roinneadh <strong>tábla nó radharc</strong> leat",
    ...
    "Deleted team %s." : "Scriosadh an fhoireann %s.",
    "A new table row has been created in view %2$s by %1$s." : "Tá sraith nua tábla cruthaithe sa radharc %2$s ag %1$s.",
    "A new table row has been created in table %2$s by %1$s." : "Tá sraith nua tábla cruthaithe i dtábla %2$s ag %1$s.",
    "{user} has created a new {row} in view {view}" : "Chruthaigh {user} {row} nua i radharc {view}",
    "{user} has created a new {row} in table {table}" : "Chruthaigh {user} {row} nua i dtábla {table}",
    "A table row has been updated in view %2$s by %1$s." : "Tá sraith tábla nuashonraithe sa radharc %2$s ag %1$s.",
    "A table row has been updated in table %2$s by %1$s." : "Tá sraith tábla nuashonraithe i dtábla %2$s ag %1$s.",
    "{user} has updated this {row} in view {view}" : "Tá an {row} seo nuashonraithe ag {user} i radharc {view}",
    "{user} has updated this {row} in table {table}" : "Tá an {row} seo nuashonraithe ag {user} i dtábla {table}",
    "A table row has been deleted from view %2$s by %1$s." : "Scrios %1$s sraith tábla as an radharc %2$s.",
    "A table row has been deleted from table %2$s by %1$s." : "Scrios %1$s sraith tábla ó thábla %2$s.",
    "{user} has deleted this {row} in view {view}" : "Scrios {user} an {row} seo i radharc {view}",
    "{user} has deleted this {row} in table {table}" : "Scrios {user} an {row} seo i dtábla {table}",
    "Group %2$s has been assigned in row %3$s of view %4$s by %1$s." : "Tá grúpa %2$s sannta i ró %3$s den radharc %4$s ag %1$s.",
    "Group %2$s has been assigned in row %3$s of table %4$s by %1$s." : "Tá grúpa %2$s sannta i ró %3$s den tábla %4$s ag %1$s.",
    "{user} has assigned group {group} in {row} in view {view}" : "Tá grúpa {group} sannta ag {user} i {row} sa radharc {view}",
    "{user} has assigned group {group} in {row} in table {table}" : "Tá grúpa {group} sannta ag {user} i {row} sa tábla {table}",
    "Team %2$s has been assigned in row %3$s of view %4$s by %1$s." : "Tá foireann %2$s sannta i sraith %3$s den radharc %4$s ag %1$s.",
    "Team %2$s has been assigned in row %3$s of table %4$s by %1$s." : "Tá foireann %2$s sannta i ró %3$s de thábla %4$s ag %1$s.",
    "{user} has assigned team {team} in {row} in view {view}" : "Tá foireann {team} sannta ag {user} i {row} i radharc {view}",
    "{user} has assigned team {team} in {row} in table {table}" : "Tá foireann {team} sannta ag {user} i {row} sa tábla {table}",
    "You have been assigned in row %2$s of view %3$s by %1$s." : "Tá %1$s tar éis tú a shannadh i ró %2$s den radharc %3$s.",
    "You have been assigned in row %2$s of table %3$s by %1$s." : "Tá tú sannta i ró %2$s den tábla %3$s ag %1$s.",
    "{user} has assigned you in {row} in view {view}" : "Tá tú sannta ag {user} i {row} in amharc {view}",
    "{user} has assigned you in {row} in table {table}" : "Tá tú sannta ag {user} i {row} sa tábla {table}",
    "A new column has been created in view %2$s by %1$s." : "Tá colún nua cruthaithe sa radharc %2$s ag %1$s.",
    "A new column has been created in table %2$s by %1$s." : "Tá colún nua cruthaithe i dtábla %2$s ag %1$s.",
    "A column has been updated in view %2$s by %1$s." : "Tá colún nuashonraithe sa radharc %2$s ag %1$s.",
    "A column has been updated in table %2$s by %1$s." : "Tá colún nuashonraithe i dtábla %2$s faoi %1$s.",
    "A column has been deleted from view %2$s by %1$s." : "Scrios %1$s colún ón radharc %2$s.",
    "A column has been deleted from table %2$s by %1$s." : "Scrios %1$s colún ón tábla %2$s.",
    "You have imported file to view {view}" : "Tá comhad allmhairithe agat chun {view} a fheiceáil.",
    "{user} has imported file to view {view}" : "Tá an comhad {view} iompórtáilte ag {user} lena fheiceáil.",
    "Your import to view {view} has failed" : "Theip ar d’ionchur chun {view} a fheiceáil.",
    "{user}'s import to view {view} has failed" : "Theip ar an iompórtáil ó {user} chun {view} a fheiceáil.",
    "Your import to table {table} has failed" : "Theip ar d’ion-iompórtáil chuig an tábla {table}",
    "{user}'s import to table {table} has failed" : "Theip ar an iompórtáil chuig an tábla {table} do {user}",
    "Nextcloud tables" : "Táblaí Nextcloud",
    "_%n row_::_%n rows_" : ["%n ró","%n rónna","%n rónna","%n rónna","%n rónna"],
    "table" : "tábla",
    "table view" : "amharc tábla",
    "Column width must be between %1$s and %2$s." : "Ní mór leithead an cholúin a bheith idir %1$s agus %2$s.",
    "Show preview must be a boolean value." : "Caithfidh luach Boole a bheith i gceist le réamhamharc an taispeántais.",
    "Image preview size must be between %1$s and %2$s." : "Caithfidh méid réamhamhairc na híomhá a bheith idir %1$s agus %2$s.",
    ...
    "Column \"%s\" contains an invalid protocol. Only http and https are allowed." : "Tá prótacal neamhbhailí sa cholún \"%s\". Ní cheadaítear ach http agus https.",
    ...
    "View %s" : "Féach %s",
    "%s (View)" : "%s (Radharc)",
    "Application %s" : "Feidhmchlár %s",
    "%s (Application)" : "%s (Feidhmchlár)",
    "Unknown %s" : "%s anaithnid",
    "Read" : "Léigh",
    "Update" : "Nuashonrú",
    "Create" : "Cruthaigh",
    "Delete" : "Scrios",
    "Manage" : "Bainistigh",
    "Administer the shared table and its sharing" : "Riar an tábla comhroinnte agus a chomhroinnt",
    "All tables, columns, rows, contexts, and sharing information including all tables owned or shared, their structure and content" : "Gach tábla, colún, sraith, comhthéacs agus faisnéis chomhroinnte lena n-áirítear gach tábla atá faoi úinéireacht nó comhroinnte, a struchtúr agus a n-ábhar",
    ...
    "Move up" : "Éirí suas",
    "Move down" : "Bog síos",
    "Rules are applied in order. The first rule sorts all rows, and any additional rules determine the order within any group of rows that share the same value." : "Cuirtear rialacha i bhfeidhm in ord. Sórtálann an chéad riail na sraitheanna go léir, agus cinneann aon rialacha breise an t-ord laistigh d'aon ghrúpa sraitheanna a bhfuil an luach céanna acu.",
    ...
    "Shares" : "Scaireanna",
    "Actions" : "Gníomhartha",
    "View settings" : "Féach ar shocruithe",
    "Share" : "Comhroinn",
    ...
    "Table settings" : "Socruithe boird",
    "Create column" : "Cruthaigh colún",
    "Import scheme" : "Scéim allmhairithe",
    "Import" : "Iompórtáil",
    "Export all rows" : "Easpórtáil na sraitheanna go léir",
    "Import rows" : "Iompórtáil sraitheanna",
    "Export filtered rows" : "Easpórtáil sraitheanna scagtha",
    ...
    "Your access was revoked. Reload the page to update your permissions." : "Cuireadh deireadh le do rochtain. Athlódáil an leathanach chun do cheadanna a nuashonrú.",
    "Manage view" : "Bainistigh radharc",
    "Please insert a title for the new column." : "Cuir isteach teideal don cholún nua le do thoil.",
    "Cannot save column. Technical name must start with a lowercase letter and only contain lowercase letters, numbers, and underscores." : "Ní féidir an colún a shábháil. Ní mór don ainm teicniúil tosú le litir bheag agus ní mór dó ach litreacha beaga, uimhreacha agus fo-línte a bheith ann.",
    ...
    "Please select a relation type." : "Roghnaigh cineál caidrimh le do thoil.",
    "Please select a target." : "Roghnaigh sprioc le do thoil.",
    "Please select a label for relation selection." : "Roghnaigh lipéad le do thoil le haghaidh roghnú caidrimh.",
    ...
    "Fill form" : "Líon an fhoirm",
    "Create row" : "Cruthaigh ró",
    "Fill form again" : "Líon an fhoirm arís",
    "Submit" : "Cuir isteach",
    "Form successfully submitted." : "Cuireadh an fhoirm isteach go rathúil.",
    ...
    "Column order" : "Ord na gcolún",
    "Default sorting" : "Sórtáil réamhshocraithe",
    "Owner" : "Úinéir",
    ...
    "File import started, this might take a while. You will be notified once it finished." : "Iompórtáil comhaid tosaithe, d'fhéadfadh sé seo tamall a thógáil. Cuirfear ar an eolas thú nuair a bheidh sé críochnaithe.",
    ...
    "Could not import due to unknown errors." : "Níorbh fhéidir an t-iompórtáil a dhéanamh mar gheall ar earráidí anaithnide.",
    "Import application scheme" : "Scéim iarratais allmhairithe",
    "Preview application scheme changes" : "Réamhamharc ar athruithe ar scéim an iarratais",
    "No file selected for import." : "Níl aon chomhad roghnaithe le haghaidh allmhairithe.",
    "No scheme data to import." : "Gan aon sonraí scéime le hallmhairiú.",
    "Could not import scheme due to unknown errors." : "Níorbh fhéidir an scéim a iompórtáil mar gheall ar earráidí anaithnide.",
    "The selected file is not valid JSON." : "Ní comhad JSON bailí é an comhad roghnaithe.",
    "Import application scheme from a file" : "Scéim feidhmchláir a allmhairiú ó chomhad",
    "Supported formats: json" : "Formáidí tacaithe: json",
    "Import completed successfully." : "Iompórtáil críochnaithe go rathúil.",
    "Back" : "Ar ais",
    "From" : "Ó",
    "To" : "Chun",
    "Icon" : "Deilbhín",
    "New Tables" : "Táblaí Nua",
    "Emoji" : "Emoji",
    "No columns to add" : "Gan aon cholúin le cur leis",
    "Change Tables" : "Athraigh Táblaí",
    "No columns to change" : "Gan aon cholúin le hathrú",
    "ID (Meta)" : "ID (Meitea)",
    ...
    "Import table scheme" : "Scéim tábla allmhairithe",
    "Preview table scheme changes" : "Réamhamharc ar athruithe ar scéim an tábla",
    "Import table scheme from a file" : "Scéim tábla a allmhairiú ó chomhad",
    "New Columns" : "Colúin Nua",
    "Technical name" : "Ainm teicniúil",
    "Change Columns" : "Athraigh Colúin",
    "Remove Columns" : "Bain Colúin",
    "No columns to remove" : "Gan aon cholúin le baint",
    "New Views" : "Radharcanna Nua",
    "views" : "radhairc",
    "No views to add" : "Gan aon radharcanna le cur leis",
    "Change Views" : "Athraigh Radharcanna",
    "No views to change" : "Gan aon radharcanna le hathrú",
    "Remove Views" : "Bain Radharcanna",
    "No views to remove" : "Gan aon radharcanna le baint",
    "Column Order" : "Ord na gColún",
    "Sort" : "Sórtáil",
    ...
    "Cannot save view. Technical name must start with a lowercase letter and only contain lowercase letters, numbers, and underscores." : "Ní féidir an radharc a shábháil. Ní mór don ainm teicniúil tosú le litir bheag agus ní mór dó ach litreacha beaga, uimhreacha agus fo-línte a bheith ann.",
    ...
    "Show advanced settings" : "Taispeáin socruithe ardleibhéil",
    "Optional, e.g. customer_view" : "Roghnach, m.sh. customer_view",
    "Changing the technical name affects integrations and API. Make sure to update your services accordingly." : "Bíonn tionchar ag athrú an ainm theicniúil ar chomhtháthú agus ar an API. Déan cinnte do sheirbhísí a nuashonrú dá réir.",
    "Content changes" : "Athruithe ar an ábhar",
    "When row values are created, updated or deleted." : "Nuair a chruthaítear, a nuashonraítear nó a scriostar luachanna sraithe.",
    "Structure changes" : "Athruithe struchtúir",
    "When columns are created, updated or deleted." : "Nuair a chruthaítear, a nuashonraítear nó a scriostar colúin.",
    "Assigned" : "Sannta",
    "When you are added in a user or group field." : "Nuair a chuirtear i réimse úsáideora nó grúpa thú.",
    "Could not load notification settings." : "Níorbh fhéidir socruithe fógra a lódáil.",
    "Could not update notification settings." : "Níorbh fhéidir socruithe fógraí a nuashonrú.",
    "These settings are stored separately for each table and view." : "Stóráiltear na socruithe seo ar leithligh do gach tábla agus radharc.",
    "Loading notification settings" : "Ag lódáil socruithe fógra",
    "Saving..." : "Shábháil...",
    "Export scheme" : "Scéim onnmhairithe",
    ...
    "Quick share options, current: {option}" : "Roghanna comhroinnte tapa, reatha: {option}",
    "Error creating link share" : "Earráid ag cruthú comhroinnt nasc",
    "Error deleting link share" : "Earráid ag scriosadh comhroinnt nasc",
    "Link copied to clipboard" : "Cóipeáladh an nasc chuig an ngearrthaisce",
    "Error copying link" : "Earráid ag cóipeáil an naisc",
    "Password copied" : "Pasfhocal cóipeáilte",
    "Error copying password" : "Earráid ag cóipeáil pasfhocail",
    ...
    "Copy public share link" : "Cóipeáil nasc comhroinnte poiblí",
    ...
    "Download" : "Íoslódáil",
    "This is a public form." : "Is foirm phoiblí í seo.",
    "Create rows" : "Cruthaigh sraitheanna",
    "You can add one or more replies." : "Is féidir leat freagra amháin nó níos mó a chur leis.",
    ...
    "Options" : "Roghanna",
    "This relation does not exist anymore." : "Níl an gaol seo ann a thuilleadh.",
    "Select relation value" : "Roghnaigh luach caidrimh",
    ...
    "Hide advanced settings" : "Folaigh socruithe ardleibhéil",
    "Enter a column title" : "Cuir isteach teideal colún",
    "Add column to other views" : "Cuir colún le radhairc eile",
    "Optional, e.g. customer_name" : "Roghnach, m.sh. ainm_an_chustaiméara",
    ...
    "Relation type" : "Cineál caidrimh",
    "Select relation type" : "Roghnaigh cineál caidrimh",
    "Select target" : "Roghnaigh sprioc",
    "Label for relation selection" : "Lipéad le haghaidh roghnú caidrimh",
    "Select label for relation selection" : "Roghnaigh lipéad le haghaidh roghnú caidrimh",
    "Only text and number columns can be used as label" : "Ní féidir ach colúin téacs agus uimhreacha a úsáid mar lipéad",
    ...
    "Shows previews for files selected from Files when a preview is available." : "Taispeánann sé réamhamhairc do chomhaid a roghnaíodh ó Chomhaid nuair a bhíonn réamhamharc ar fáil.",
    "Enable the Files provider to show previews." : "Cumasaigh an soláthraí comhad chun réamhamhairc a thaispeáint.",
    ...
    "Show previews" : "Taispeáin réamhamhairc",
    "Preview size" : "Méid réamhamhairc",
    "Enter a preview size between {min} and {max}" : "Cuir isteach méid réamhamhairc idir {min} agus {max}",
    "Preview size must be between {min} and {max} pixels." : "Caithfidh méid an réamhamhairc a bheith idir {min} agus {max} picteilín.",
    ...
    "Enter a value between {min} and {max}." : "Cuir isteach luach idir {min} agus {max}.",
    "Enter a value of {min} or more." : "Cuir isteach luach {min} nó níos mó.",
    "Enter a value of {max} or less." : "Cuir isteach luach {max} nó níos lú.",
    ...
    "Export selected rows" : "Easpórtáil na sraitheanna roghnaithe",
    ...
    "Could not create public link." : "Níorbh fhéidir nasc poiblí a chruthú.",
    ...
    "Contains items" : "Tá míreanna ann",
    "Contains" : "Cuimsíonn",
    ...
    "Could not load view." : "Níorbh fhéidir an radharc a lódáil.",
    ...
    "Could not load relation data." : "Níorbh fhéidir sonraí caidrimh a luchtú.",
    ...
    "Could not verify export permissions." : "Níorbh fhéidir ceadanna easpórtála a fhíorú.",
