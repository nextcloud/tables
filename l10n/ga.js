OC.L10N.register(
    ...
    "_You have updated cell _::_You have updated cells _" : ["Tá cill nuashonraithe agat","Tá cealla nuashonraithe agat","Tá cealla nuashonraithe agat","Tá cealla nuashonraithe agat","Tá cealla nuashonraithe agat"],
    "_{user} has updated cell(s) _::_{user} has updated cells _" : ["Tá cealla nuashonraithe ag {user}","Tá cealla nuashonraithe ag {user}","Tá cealla nuashonraithe ag {user}","Tá cealla nuashonraithe ag {user}","Tá cealla nuashonraithe ag {user}"],
