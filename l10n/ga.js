OC.L10N.register(
    ...
    "An error caused by an invalid request occurred. More details can be found in the logs. Please reach out to your administration." : "Tharla earráid de bharr iarratas neamhbhailí. Is féidir tuilleadh sonraí a fháil sna logs. Déan teagmháil le do riarachán le do thoil.",
    ...
    "We have heard that Nextcloud could be a nice solution for it, should give it a try." : "Tá sé cloiste againn go bhféadfadh Nextcloud a bheith ina réiteach deas dó, ba cheart dó triail a bhaint as.",
    ...
    "After table promotion, any applications based on this table created by the share recipients will continue to consume its data even if you demote them later" : "Tar éis cur chun cinn tábla, leanfaidh aon fheidhmchláir atá bunaithe ar an tábla seo cruthaithe ag na faighteoirí scaireanna ar aghaidh ag úsáid a shonraí fiú má dhíscaoileann tú iad níos déanaí",
    ...
    "Search for table and views..." : "Cuardaigh tábla agus radharcanna...",
    ...
    "Start of the year" : "Tús na bliana",
    "Start of the month" : "Tús na míosa",
    "Start of the week" : "Tús na seachtaine",
    "Now" : "Anois",
    "ID" : "ID",
