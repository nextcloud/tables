OC.L10N.register(
    "tables",
    {
    "An unexpected error occurred. More details can be found in the logs. Please reach out to your administrator." : "Es ist ein unerwarteter Fehler aufgetreten. Weitere Details finden Sie in den Protokollen. Bitte wenden Sie sich an Ihre Administration.",
    ...
    "Note that imported data will be added to the table. Updating of existing rows is not possible at the moment." : "Beachten Sie, dass importierte Daten zur Tabelle hinzugefügt werden. Das Aktualisieren bestehender Zeilen ist derzeit nicht möglich.",
