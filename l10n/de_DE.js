OC.L10N.register(
    ...
    "_Are you sure you want to delete the selected row?_::_Are you sure you want to delete the %n selected rows?_" : ["Sind Sie sicher, dass Sie die ausgewählte Zeile löschen möchten?","Sind Sie sicher, dass Sie die %n gewählten Zeilen löschen möchten?"],
    "_%n row was saved._::_%n rows were saved._" : ["%n Zeile wurde gespeichert.","%n Zeilen wurden gespeichert."],
    "_Selected row was deleted._::_Selected %n rows were deleted._" : ["Gewählte Zeile wurde gelöscht.","Gewählte %n Zeilen wurden gelöscht."],
