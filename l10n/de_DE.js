OC.L10N.register(
    ...
    "An error caused by an invalid request occurred. More details can be found in the logs. Please reach out to your administration." : "Es ist ein Fehler aufgetreten, der durch eine ungültige Anfrage verursacht wurde. Weitere Details finden Sie in den Protokollen. Bitte wenden Sie sich an Ihre Verwaltung.",
    ...
    "Title" : "Titel",
    "Select icon for the application" : "Icon für die Anwendung erstellen",
    "Select icon" : "Icon auswählen",
    "Title of the new application" : "Titel der neuen Anwendung",
    "Description of the new application" : "Beschreibungd er neuen Anwendung",
    ...
    "Cannot create new context. Title is missing." : "Neuer Kontext konnte nicht erstellt werden. Ein Titel fehlt.",
    ...
    "The title limit is reached with 200 characters." : "Dir Titel ist auf 200 Zeichen beschränkt",
    "Cannot update context. Title is missing." : "Der Kontext konnte nicht aktualisiert werden. Ein Titel fehlt.",
    "Updated context \"{contextTitle}\"." : "Kontext aktualisiert \"{contextTitle}\".",
    ...
    "Transfer this application to another user" : "Diese Anwendung auf einen anderern Benutzer übertragen",
    "Transfer" : "Übertragen",
    "Context \"{name}\" transfered to {user}" : "Kontext „{name}“ wurde auf {user} übertragen",
    "Transfer table" : "Tabelle übertragen",
    "Transfer this table to another user" : "Diese Tabelle auf einen anderen Benutzer übertragen",
    "Table \"{emoji}{table}\" transfered to {user}" : "Tabelle \"{emoji}{table}\" an {user} übertragen",
