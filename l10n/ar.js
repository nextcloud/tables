OC.L10N.register(
    ...
    "After table promotion, any applications based on this table created by the share recipients will continue to consume its data even if you demote them later" : "بعد رفع رتبة الجدول، ستستمر أي تطبيقات تعتمد على هذا الجدول تم إنشاؤها بواسطة مستلمي المشاركة في استهلاك بياناته حتى إذا قمت بخفض رتبتها لاحقًا",
