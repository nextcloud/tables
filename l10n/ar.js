OC.L10N.register(
    ...
    "Create Vacation Request" : "أنشِيءْ طلب إجازة",
    ...
    "Create initial milestones" : "أنشِيءْ مَعالِم أوَّلِيّة للمراحل",
    ...
    "Done" : "أُنجز",
    "Open the tables app" : "إفتح تطبيق الجداول ",
    ...
    "We need at least one column, please be so kind and create one." : "نحتاج عموداً واحداً على الأقل. أنشِيءْ واحداً رجاءً.",
    ...
    "First row of the file must contain column headings." : "السطر الأول من الملف يجب أن يحتوي على ترويسات العمود.",
    ...
    "group" : "مجموعة",
    "Table manager" : "مدير الجدول Table manager",
    ...
    "Promote to table manager" : "الترفيع إلى مدير جدول",
    "Demote to normal share" : "التخفيض إلى مشاركة عادية",
    "Open main table to adjust table management permissions" : "إفتح الجدول الرئيسي لضبط أذونات إدارة الجدول",
    "No shares" : "لا يوجد مشاركات",
    "Created at" : "أُنشأت في",
    "Ownership" : "المِلكِيّة",
    "View ID" : "أعرُض المُعرِّف ID",
    "Sharing" : "المشاركة",
    "No view in context" : "لا توجد مناظير views ضمن السياق context",
    "From {ownerName}" : "من {ownerName}",
    "API" : "واجهة برمجة التطبيقات \"API\"",
    "This is your API endpoint for this view" : "هذه هي نقطتك الحدِّيَّة endpoint لـ API لهذا المنظور",
    "Copy to clipboard" : "نسخ الرابط إلى الحافظة",
    "Your permissions" : "الأذونات الخاصة بك",
    "Read" : "القراءة",
    "Update" : "تحديث",
    "Manage" : "يدير",
    "Integration URL copied to clipboard" : "عنوان URL للمُكاملة تمّ نسخه إلى الحافظة",
    ...
    "Users" : "المستخدمين",
    "Groups" : "المجموعات",
    "Select multiple items" : "حدِّد عدة عناصر",
