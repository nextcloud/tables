OC.L10N.register(
    ...
    "Text-line" : "سطر نصي",
    "Text long" : "طول النص",
    "Single select" : "إختيار فردي",
    "Multiselect" : "تحديد متعدد",
    "Multiple select" : "إختيار متعدد",
    "Move up" : "نقل للأعلي",
    ...
    "Could not reorder columns." : "تعذّرت إعادة ترتيب الأعمدة",
    "The column \"{column}\" was updated." : "تم تحديث العمود \"{column}\".",
    "Column removed successfully." : "تمّ بنجاحٍ حذف العمود",
    "Edit row" : "تعديل صف",
    ...
    "The table \"{emoji} {table}\" is ready to use." : "الجدول \"{emoji} {table}\" جاهزٌ للاستعمال.",
    ...
    "Add a new share" : "إضافة مشاركة جديدة",
    ...
    "No table in context" : "لا يوجد جدول في السياق",
    "From {ownerName}" : "من {ownerName}",
    "Sharing" : "المشاركة",
    "API" : "واجهة برمجة التطبيقات \"API\"",
    "This is your API endpoint for this table" : "هذه هي نقطة نهاية واجهة برمجة التطبيقات الخاصة بك لهذا الجدول",
