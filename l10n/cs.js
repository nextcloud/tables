OC.L10N.register(
    ...
    "If you try to import with the order of columns, see the third attemp above, you need to blind columns at the beginnig." : "Pokud se pokusíte importovat s pořadím sloupců a výše uvidíte třetí pokus, potřebujete slepé sloupce na začátku.",
    "If you are on a Chrome browser, you have to create a row first. this one can be clicked an the insert process should run." : "Pokud používáte prohlížeč Chrome, je třeba nejprve vytvořit řádek. Na ten pak lze kliknout a proces vkládání by se měl spustit.",
    "Could not fetch rows for table" : "Nepodařilo se získat řádky tabulky",
    "All tables" : "Všechny tabulky",
    "Owner" : "Vlastník",
    "Created at" : "Vytvořeno",
    "Internal ID" : "Vnitřní identif.",
    ...
    "There is a bug with the editor on mobile devices, thats why you see only a simple text box." : "Při používání editoru na mobilních zařízeních se vyskytuje chyba – z toho důvodu vidíte pouze jednoduchý textový box."
},
