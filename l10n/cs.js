OC.L10N.register(
    ...
    "Table title is updated to \"{table}\"" : "Nadpis tabulky je aktualizován na „{table}",
    ...
    "An error occurred. See the logs." : "Došlo k chybě, podrobnosti viz záznamy událostí (log).",
    ...
    "_%n row was saved._::_%n rows were saved._" : ["%n řádek byl uložen.","%n řádky byly uloženy.","%n řádků bylo uloženo.","%n řádky byly uloženy."],
    ...
    "This table is shared with you. Resharing is not allowed." : "Tato tabulka je vám nasdílena. Sdílení dál dalším není povoleno.",
