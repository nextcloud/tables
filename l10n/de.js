OC.L10N.register(
    ...
    "An error caused by an invalid request occurred. More details can be found in the logs. Please reach out to your administration." : "Es ist ein Fehler durch eine ungültige Anfrage verursacht worden. Weitere Details findest du in den Protokollen. Bitte wende dich an deine Administration.",
    ...
    "Reachable via the Tables icon in the apps list." : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    ...
    "Create views for tables" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Filter data and save table presets as views to share and combine them into applications." : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Create applications" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Combine different tables and views into no-code applications for any purpose. This makes them easily accessible directly in the app bar." : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Read the docs" : "Lese die Dokumentation",
    "If you want to go through the documentation, this can be found here: [Nextcloud Tables documentation](%s)" : "Wenn Sie die Dokumentation durchgehen möchten, finden Sie sie hier: [Nextcloud Tables-Dokumentation](%s)",
    ...
    "Application \"{context}\" removed." : "Anwendung \"{context}\" gelöscht.",
    ...
    "Could not remove application." : "Die Anwendung konnte nicht gelöscht werden.",
