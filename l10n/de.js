OC.L10N.register(
    ...
    "Search and filter (type @)" : "Suchen und filtern (@ eingeben)",
    "Column to filter for" : "Spalte nach der gefiltert werden soll",
    "You try to add a filter, make sure to chose a column, operator and filter value." : "Du versuchst, einen Filter hinzuzufügen, achte darauf, eine Spalte, einen Operator und einen Filterwert auszuwählen.",
    "Please specify a filter value." : "Bitte einen Filterwert eingeben.",
    "This option is outdated." : "Diese Einstellung ist veraltet.",
    "Export as CSV" : "Als CSV exportieren",
    "Sort this column" : "Diese Spalte sortieren",
    "Undo" : "Rückgängig",
