...
/**
 * Handles Airtable field type: lastModifiedTime
 *
 * Maps to a datetime/datetime column so the original Airtable last-modified
 * timestamp is preserved as an importable data column.
 */
class LastModifiedTimeConverter extends AbstractConverter {
