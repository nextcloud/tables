 ...
 *  columns: int[],
 *  sort: ?array{array-key, array{columnId: int, mode: 'ASC'|'DESC'}},
 *  filter: ?array{array-key, array{columnId: int, operator: 'begins-with'|'ends-with'|'contains'|'is-equal'|'is-greater-than'|'is-greater-than-or-equal'|'is-lower-than'|'is-lower-than-or-equal'|'is-empty', value: string|int|float}},
 * 	isShared: bool,
