...
class Version2400Date20260904000000 extends SimpleMigrationStep {
	...
	public function postSchemaChange(IOutput $output, Closure $schemaClosure, array $options): void {
		...
		foreach ($archivedTables as $tableRow) {
			...
			// The owner deliberately gets no override row: the entity-level
			// flag already represents their state, and an override would
			// survive an unarchive that only resets that flag.
