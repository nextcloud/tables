...
class RowOCSController extends AOCSController {
	 ...
	 * @param list<array{columnId: int, operator: 'begins-with'|'ends-with'|'contains'|'is-equal'|'is-greater-than'|'is-greater-than-or-equal'|'is-lower-than'|'is-lower-than-or-equal'|'is-empty',value: string|int|float}>|null $filter
	 * @param list<array{columnId: int, mode: 'ASC'|'DESC'}>|null $sort
	 */
	#[NoAdminRequired]
