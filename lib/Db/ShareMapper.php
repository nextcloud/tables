...
class ShareMapper extends QBMapper {
	...
	private function applyShareReviewFilters(IQueryBuilder $qb, ShareReviewQuery $query, ?array $receiverTypes, ?array $permissionColumns): void {
		...
		if ($query->modifiedBeforeTimestamp !== null) {
			$qb->andWhere($expr->lt('s.last_edit_at', $qb->createNamedParameter(new \DateTime('@' . $query->modifiedBeforeTimestamp), IQueryBuilder::PARAM_DATETIME_MUTABLE)));
		}
